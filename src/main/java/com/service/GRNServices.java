...
public class GRNServices {
	...
	public static EMSGRNBean uploadPic(HttpServletRequest request) {
		...
		try {
	        ...
	        File file = new File("/Users/ompatel/Desktop/Java Eclipse/workspace/EMS2/src/main/webapp/GRNImages/".concat(fileName));
	        File file1 = new File("/Users/ompatel/Desktop/Java Eclipse/workspace/EMS2/src/main/webapp/GRNImages/".concat(fileName1));
