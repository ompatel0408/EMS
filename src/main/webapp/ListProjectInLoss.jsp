												...
												<table id="example1"
													...
													<thead>
														<tr>
															...
															<th style="width: 17%">AdvancePayPercent</th>
															<th style="width: 17%">AfterPayPercent</th>
															<th style="width: 17%">ClientName</th>
														</tr>
													</thead>
													<tbody>
														<%
														...
														<tr>
															...
															<td><%=p.getAdvancePayPercent()%></td>
															<td><%=p.getAfterPayPercent()%></td>
